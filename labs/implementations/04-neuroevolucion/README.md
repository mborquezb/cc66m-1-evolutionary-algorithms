...
conda activate cc66m-grupo5-lab4

# registro del kernel
python -m ipykernel install --user --name cc66m-grupo5-lab4 --display-name "Python (cc66m-grupo5-lab4)"
...
conda deactivate
conda clean --all --yes
conda remove -n cc66m-grupo5-lab4 --all
