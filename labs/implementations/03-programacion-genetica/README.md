...
conda activate cc66m-grupo5-lab3

# registro del kernel
python -m ipykernel install --user --name cc66m-grupo5-lab3 --display-name "Python (cc66m-grupo5-lab3)"
...
conda deactivate
conda clean --all --yes
conda remove -n cc66m-grupo5-lab3 --all
