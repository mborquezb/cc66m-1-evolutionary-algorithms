...
conda activate cc66m-grupo5-lab1

# registro del kernel
python -m ipykernel install --user --name cc66m-grupo5-lab1 --display-name "Python (cc66m-grupo5-lab1)"
...
conda deactivate
conda clean --all --yes
conda remove -n cc66m-grupo5-lab1 --all
